...
let make = (~title, ~subtitle=?) =>
  <div className="w-full relative md:mt-32 p-4 md:p-0">
    <div className="flex flex-col justify-center items-center relative h-full text-center">
      <div className="pt-16 pb-8 text-center max-w-xl">
        ...
        <h1 className="text-4xl md:text-6xl leading-tight"> {React.string(title)} </h1>
        {switch subtitle {
